...
const doctors = [
    {
      ...
      role: "Orthodontist",
      image: "../ASSETS/IMAGES/pexels-tima-miroshnichenko-5452268.jpg",
      doctor_desc: "A highly skilled specialist with years of experience in modern dental procedures.Passionate about patient care and oral health.",
      facebook: "#",
      twitter: "#",
      instagram: "#"
    },
    {
      name: "Dr. Michael Lee",
      role: "Endodontist",
      image: "../ASSETS/IMAGES/pexels-shkrabaanthony-6749777.jpg",
      doctor_desc: "A highly skilled specialist with years of experience in modern dental procedures.Passionate about patient care and oral health.",
      facebook: "#",
      twitter: "#",
      instagram: "#"
    ...
    },
    {
      ...
      role: "Prosthodontist",
      image: "../ASSETS/IMAGES/pexels-shkrabaanthony-5215024.jpg",
      doctor_desc: "A highly skilled specialist with years of experience in modern dental procedures.Passionate about patient care and oral health.",
      facebook: "#",
      twitter: "#",
      instagram: "#"
  ...
  doctors.forEach(doc => {
    ...
    card.innerHTML = `
      ...
      <h3>${doc.name}</h3>
      <span>${doc.role}</span>
       <p class="doctor-desc">${doc.doctor_desc}</p>
      <div class="doctor-social">
        <a href="${doc.facebook}"><i class="fab fa-facebook-f"></i></a>
        <a href="${doc.twitter}"><i class="fab fa-twitter"></i></a>
        <a href="${doc.instagram}"><i class="fab fa-instagram"></i></a>
      </div>
    `;
